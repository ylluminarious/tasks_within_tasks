...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'tasks-within-tasks.com'
  config.app_name = 'Tasks_within_tasks'
  config.mailer.from = 'Tasks_within_tasks <no-reply@tasks-within-tasks.com>'
  ...
  #
  config.app_secret = '5LvDHv53MG6mXpYer3BMFrDFti5U7FTMKjvcfSYa7BV5VIYziH3MYAk_hTlQRFP4ldU'
